void LCD_mainMenu() {
  ...
  switch (_mode) {
    case MenuMode:
      ...
      //      lcd.setCursor(0, 0);
      //      lcd.print(String(random(1, 12)) + " ");
      //      lcd.setCursor(2, 0);
      //      lcd.print(":");
      //      lcd.setCursor(3, 0);
      //      lcd.print(String(random(1, 12)) + "   ");
      //      lcd.setCursor(8, 0);
      //      lcd.print(String(random(2000, 2022)) + "/");
      //      lcd.setCursor(13, 0);
      //      lcd.print(String(random(1, 12)) + " ");
      //      lcd.setCursor(15, 0);
      //      lcd.print("/");
    ...
    case MonitoringMode:
      ...
      //      lcd.setCursor(0, 3);
      //      lcd.print("3.PZEM C Condition  ");
      //      if ((_mode == MonitoringMode) and (customKey == '1')) {
      //        lcd.setCursor(0, 0);
      //        lcd.print("Voltage A = " + String(voltage[0]) + "   ");
      //        lcd.setCursor(0, 1);
      //        lcd.print("Current A = " + String(current[0]) + "   ");
      ...
      //        lcd.print("Energy A = " + String(energy[0]) + "     ");
      //      }
      //      else if ((_mode == MonitoringMode) and (customKey == '2')) {
      //        lcd.setCursor(0, 0);
      //        lcd.print("Voltage B = " + String(voltage[1]) + "   ");
      //        lcd.setCursor(0, 1);
      //        lcd.print("Current B = " + String(current[1]) + "   ");
      ...
      //        lcd.print("Energy B = " + String(energy[1]) + "     ");
      //      }
      //      else if ((_mode == MonitoringMode) and (customKey == '3')) {
      //        lcd.setCursor(0, 0);
      //        lcd.print("Voltage C = " + String(voltage[2]) + "   ");
      //        lcd.setCursor(0, 1);
      //        lcd.print("Current C = " + String(current[2]) + "   ");
      ...
      //          lcd.print("Voltage B = " + String(voltage[1]) + "   ");
      //          lcd.setCursor(0, 1);
      //          lcd.print("Current B = " + String(current[2]) + "   ");
      //          lcd.setCursor(0, 2);
      //          lcd.print("Power B = " + String(power[3]) + "      ");
      //          lcd.setCursor(0, 3);
      //          lcd.print("Energy B = " + String(energy[4]) + "     ");
      //          lcd_flg += 1;
      //        } else if (lcd_flg == 2) {
      //          lcd.setCursor(0, 0);
      //          lcd.print("Voltage C = " + String(voltage[1]) + "   ");
      //          lcd.setCursor(0, 1);
      //          lcd.print("Current C = " + String(current[2]) + "   ");
      //          lcd.setCursor(0, 2);
      //          lcd.print("Power C = " + String(power[3]) + "      ");
      //          lcd.setCursor(0, 3);
      //          lcd.print("Energy C = " + String(energy[4]) + "     ");
      //          lcd_flg = 0;
      //        }
      //      }
      break;
    case TempMode:
      ...
      break;
    case MainControl:
      //      if (customKey == '1') _ctrlMode = MotorCondition;
      //      else if (customKey == '2') _ctrlMode = LampCondition;

      //      lcd.setCursor(0, 0);
      //      lcd.print("   MOTOR CONTROL    ");
      //      lcd.setCursor(0, 1);
      //      lcd.print("1. MOTOR Condition  ");
      //      lcd.setCursor(0, 2);
      ...
      switch (_ctrlMode) {
        ...
        case RelayCondition:
          ...
          else if ((stateRelay[2]) and (customKey == '1')) {
            stateRelay[2] = 2;
      ...
      //      if (customKey == '1') {
      //              if ((!stateRelay[0]) and (customKey == '1')) stateRelay[0] = true;
      //              else if ((stateRelay[0]) and (customKey == '1')) stateRelay[0] = false;
      //              if ((!stateRelay[1]) and (customKey == '2')) stateRelay[1] = true;
      //              else if ((stateRelay[1]) and (customKey == '2')) stateRelay[1] = false;
      //              if ((!stateRelay[2]) and (customKey == '3')) stateRelay[2] = true;
      //              else if ((stateRelay[2]) and (customKey == '3')) stateRelay[2] = false;
      //
      //              lcd.setCursor(0, 0);
      //              lcd.print("   RELAY CONTROL    ");
      //              lcd.setCursor(0, 1);
      //              if (stateRelay[0]) lcd.print("1. Relay Satu= ON.  ");
      //              else lcd.print("1. Relay Satu= OFF. ");
      //              lcd.setCursor(0, 2);
      //              if (stateRelay[1]) lcd.print("2. Relay Dua= ON.   ");
      //              else lcd.print("2. Relay Dua= OFF.  ");
      //              lcd.setCursor(0, 3);
      //              if (stateRelay[2]) lcd.print("3. Relay Tiga= ON.  ");
      //              else lcd.print("3. Relay Tiga= OFF. ");
      //      } else if (customKey == '2') {
      //              lcd.setCursor(0, 0);
      //              lcd.print("     RBD DImmer     ");
    ...
    //          lcd.setCursor(0, 3);
    //          lcd.print("            <Down>  ");
    //          if (index_ == '2') outVal += 20;
    //          else if (index_ == '8') outVal -= 20;
    //      break;
    //    case RelayControlMode:
    //          if ((!stateRelay[0]) and (index_ == '1')) stateRelay[0] = true;
    //          else if ((stateRelay[0]) and (index_ == '1')) stateRelay[0] = false;
    //          if ((!stateRelay[1]) and (index_ == '2')) stateRelay[1] = true;
    //          else if ((stateRelay[1]) and (index_ == '2')) stateRelay[1] = false;
    //          if ((!stateRelay[2]) and (index_ == '3')) stateRelay[2] = true;
    //          else if ((stateRelay[2]) and (index_ == '3')) stateRelay[2] = false;
    //
    //          lcd.setCursor(0, 0);
    //          lcd.print("   RELAY CONTROL    ");
    //          lcd.setCursor(0, 1);
